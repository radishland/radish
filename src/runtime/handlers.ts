        ...
        for (const property of Object.keys(bindingConfig)) {
          if (entry.hasAttribute(`@bind:${property}`)) {
            ...
            const bindRequest = new CustomEvent("@bind-request", {
              ...
              composed: true,
              detail: {
                property: property as keyof typeof bindingConfig,
                identifier,
                handled: false,
